...
def filter_datum(fields: List[str], redaction: str, message: str,
    ...
    This function replaces the values of fields in a log message with a provided
    redaction string. It uses regular expressions to match field names and their
    ...
    Args:
      ...
      separator: The character used as a separator between fields and their values
                 in the log message.

    Returns:
      A new string with the specified fields redacted using the provided redaction string.
    """
